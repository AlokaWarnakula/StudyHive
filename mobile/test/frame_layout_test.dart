...
void main() {
  final frames = <String, Widget Function()>{
    ...
    'M-09 Browse rooms': () => const BrowseRoomsScreen(previewEnabled: true),
    'M-10 Room detail': () => const RoomDetailScreen(),
    'M-11 Free times': () => const RoomScheduleScreen(),
    'M-14 QR check-in': () => const QrCheckInScreen(previewEnabled: true),
    'M-15 Checked in': () => const CheckedInScreen(previewEnabled: true),
