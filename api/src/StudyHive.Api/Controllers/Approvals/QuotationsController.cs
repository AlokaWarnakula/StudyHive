...
/// <summary>
/// S4: quotations and their line items.
///
...
public sealed class QuotationsController : ControllerBase
{
    ...
    /// <summary>Generate a quotation. Called by the Validation agent's calculate_quotation step, not by a client.</summary>
    [HttpPost]
    [Authorize(Policy = "StaffOnly")]
    [ProducesResponseType(StatusCodes.Status501NotImplemented)]
    public IActionResult Create() => NotImplemented("Generating a quotation");

    /// <summary>List quotations.</summary>
    [HttpGet]
    [Authorize(Roles = $"{Roles.Librarian}")]
    [ProducesResponseType(StatusCodes.Status501NotImplemented)]
    public IActionResult List([FromQuery] PageQuery query) => NotImplemented("Listing quotations");

    /// <summary>Get a quotation with its line items. Backs W-05 and M-08. A student may read their own.</summary>
    [HttpGet("{id:guid}")]
    [ProducesResponseType(StatusCodes.Status501NotImplemented)]
    public IActionResult GetById(Guid id) => NotImplemented("Quotation detail");
}
